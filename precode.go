...
// getTask возвращает задачи из мапы
...
// getIdTask проверяет есть ли задача с указанным ID в мапе и возвращает её
...
func main() {
	...
	if err := http.ListenAndServe(":8080", r); err != nil {
		fmt.Printf("Ошибка при запуске сервера1: %s", err.Error())
		return
	}
}
